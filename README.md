...
<!-- STATS:START -->
_Auto-updated from **36** logged queries · last refresh 2026-07-17._

| Metric | Value |
|---|---|
| Total queries | 36 |
| — real traffic (live) | 36 |
| — benchmark traffic (automated) | 0 |
| Grounded (cited) | 100% |
| Avg latency | 13,539 ms |
| p50 / p95 latency | 6,763 / 29,950 ms |
| Avg stage split — rewrite · retrieve · rerank · llm | 387 · 4,444 · 7,902 · 805 ms |
| Avg tokens / query | 2,100 |
| Total tokens | 75,594 |
...
│   ├── meta.js                ← identity/help intent ("who are you?") — honest, no refusal
...
| The refusal gate also refused "who are you?" | A reviewer noticed identity/meta questions ("who are you?", "what can you do?") started getting the out-of-scope refusal once the gate landed — correct by the letter (not in the KB), broken by feel. Added a tiny **meta-intent handler** (`meta.js`) that answers identity/help questions with a fixed, honest description (no fabricated citations, no refusal), ahead of retrieval. Lesson: a strict scope boundary needs a graceful path for the conversational questions that fall just outside it. |
